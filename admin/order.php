                        ...
                        <tbody>
                            ...
                            ?>
                                <tr class="<?php if ($row['payment_status'] == 'Pending') {
                                    ...
                                    <td>
                                        <a href="#" class="btn btn-warning btn-xs" data-href="order-delete.php?id=<?php echo $row['id']; ?>" data-toggle="modal" data-target="#confirm-delete" style="width:100%;">Delete</a>
                                    </td>
                                </tr>
                            <?php
                            }
